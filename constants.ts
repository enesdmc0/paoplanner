export const defaultUrl = "https://paoplanner.com";
export const privacyPolicyUrl = `${defaultUrl}/privacy-policy`;
export const termsOfUseUrl = `${defaultUrl}/terms-of-use`;
export const sitemapUrl = `${defaultUrl}/sitemap.xml`;
